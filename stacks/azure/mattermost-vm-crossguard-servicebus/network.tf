# stacks/azure/mattermost-vm-crossguard-servicebus/network.tf
#
...
#
# For production: add a NAT gateway, remove public IPs from the VMs, and add
# a Service Bus private endpoint on each VM's subnet so AMQP traffic stays
