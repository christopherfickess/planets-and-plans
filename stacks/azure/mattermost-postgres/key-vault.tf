data "azurerm_key_vault" "mattermost_key_vault" {
...
resource "azurerm_key_vault_secret" "database_connection_string" {
  ...
  # value        = var.db_internal_username
  value        = "postgres://${var.db_internal_username}:${random_password.postgres_internal_password.result}@${module.mattermost_postgres.host}:${module.mattermost_postgres.port}/${module.mattermost_postgres.dbname}?sslmode=require"
  key_vault_id = data.azurerm_key_vault.mattermost_key_vault.id
