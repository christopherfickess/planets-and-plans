...
variable "principal_ids" {
  description = <<-EOT
    ...
    (e.g. "instance_a", "instance_b") — Terraform uses them as for_each keys at plan time
    so they cannot be derived from resource attributes. Values are the principal IDs.
