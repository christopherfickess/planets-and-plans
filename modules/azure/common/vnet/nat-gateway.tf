...
# NAT gateway is attached to subnets via the Azure AVM module's nat_gateway input
# (see local.subnet_configs_for_azure in vnet.tf). No separate association needed.
